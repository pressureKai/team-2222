package com.jiangtai.count.ui.map
    ...
    override fun onResume() {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            if (mapPageMajorProject.isEmpty()) {
                ...
                val b =
                    mCurrentMajorProject.isNotEmpty() && mCurrentMajorProject != mapPageMajorProject
                if (b) {
                    clear(false)
                    mapPageMajorProject = mCurrentMajorProject
                    reShowLocation()
...
//                    }
    ...
    private fun setCenterDes(center: LatLng) {
        8
        try {
                ...
                requireActivity()?.let {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed({
                        ...
                        try {
                            ...
                            latLng.text =
                                "纬度:${decimalFormat.format(locationReceiver.lat.toDouble())}"
                            latLng2.text =
                                "经度:${decimalFormat.format(locationReceiver.lng.toDouble())}"
