...
import com.jiangtai.count.dialog.SelectWayDialog
import com.jiangtai.count.event.ClearEvent
import com.jiangtai.count.event.RefreshTaskState
...
import com.jiangtai.count.net.toJsonBody
import com.jiangtai.count.response.TaskDetailModel
import com.jiangtai.count.response.TaskListModel
import com.jiangtai.count.ui.taskinfo.TaskInfoActivity
import com.jiangtai.count.util.FileUtil
...
//        }
    ...
    private fun decoderXlsFile(path: String) {
        val majorType = com.jiangtai.count.ui.majorpractice.PoiImport.isMajorType(File(path))
        if(!majorType){
