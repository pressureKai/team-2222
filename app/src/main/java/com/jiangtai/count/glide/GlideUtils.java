package com.jiangtai.count.glide;
...
public class GlideUtils {
    ...
    public static void showAnimation(ImageView view, String url, int defaultImg) {
        ...
        options.error(defaultImg);
        options.centerCrop();
        Glide.with(App.Companion.getContext()).load(url).transition(withCrossFade()).apply(options).into(view);
    ...
    public static void showCircle(ImageView view, String url, int defaultImg) {
        ...
        options.error(defaultImg);
        options.centerCrop();
        Glide.with(App.Companion.getContext()).load(TextUtils.isEmpty(url) ? defaultImg : url).apply(options).into(view);
    }
    ...
    public static void showCircleWithBorder(ImageView view, String url, int defaultImg, int BorderColor) {
        ...
        Glide.with(App.Companion.getContext()).load(url).apply(options).into(view);
    }
    ...
    public static void showIndistinct(ImageView view, String url, int defaultImg) {
        Glide.with(App.Companion.getContext()).load(url).apply(RequestOptions.bitmapTransform(new GlideBlurformation(App.Companion.getContext()))).into(view);
    }
